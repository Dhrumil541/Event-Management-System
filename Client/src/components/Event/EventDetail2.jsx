...
function EventDetails2() {
  ...
  const event = {
    imageUrl: '/assets/images/amazon1.jpg',
    title: 'Amazon Event',
    description: `The contents of the detail top-level field are different depending on which service generated the event and what the event is. The combination of the source and detail-type fields serves to identify the fields and values found in the detail field. For examples of events generated by AWS services, see Events from AWS services in Amazon EventBridge.`,
